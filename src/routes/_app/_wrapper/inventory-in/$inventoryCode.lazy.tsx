...
function InventoryInDetailPage() {
  ...
  const {
    mutateAsync: getInventoryInDetail,
    data,
    isSuccess,
  } = useGetInventoryInDetail()
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex gap-2 items-center my-3">
                ...
                <div className="text-sm">
                  <Badge variant="outline">
                    {inventoryIn?.CreatedBy?.fullname}
                  </Badge>
                </div>
              </div>
              ...
              <div className="flex gap-2 items-center my-3">
                ...
                <div className="text-sm">
                  <Badge variant="outline">
                    {moment(inventoryIn?.createdAt).format('DD/MM/YYYY')}
                  </Badge>
                </div>
              </div>
              ...
              <div className="flex gap-2 items-center my-3">
                ...
                <div className="text-sm">
                  <Badge variant="outline">
                    {inventoryIn?.ChiTietNhapKho?.[0]?.NhaCungCap?.maNhaCungCap}
                  </Badge>
                </div>
              </div>
              ...
              <div className="flex gap-2 items-center my-3">
                ...
                <div className="text-sm">
                  <Badge variant="outline">
                    {
                      inventoryIn?.ChiTietNhapKho?.[0]?.DonMuaHangChiTiet
                        ?.i_invoice
                    }
                  </Badge>
                </div>
              ...
              <div className="flex gap-2 items-center">
                ...
                <div className="text-sm">
                  <Badge variant="outline">
                    {numberWithCommas(Number(inventoryIn?.tyGia))}
                  </Badge>
                </div>
              </div>
            </CardContent>
