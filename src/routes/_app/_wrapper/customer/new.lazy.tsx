...
export const Route = createLazyFileRoute('/_app/_wrapper/customer/new')({
                ...
                <DataTableDetail
                  listTools={
                    <CreateCustomerAddress
                      saveDetail={handleAddCustomerAddress}
                    />
                  }
                  data={listAddress.map((item, index) => ({
                    ...item,
                    deleteRow: () => handleDeleteCustomerAddress(index),
                    updateRow: (val: IAddressRequestCreate) =>
                      handleUpdateCustomerAddress(index, val),
                  }))}
